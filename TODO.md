...
- [x] Show the model's activity in the UI while it is generating a response:
  - [x] Stream safe topical status updates while it is working (not raw model reasoning).
  - [x] Show a loading indication during generation.
